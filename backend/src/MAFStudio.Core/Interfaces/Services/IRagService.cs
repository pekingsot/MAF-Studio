...
public interface IRagService
{
    ...
    Task<RagQueryResult> QueryAsync(string query, int topK = 5, double scoreThreshold = 0.5, long? llmConfigId = null, long? llmModelConfigId = null, string? systemPrompt = null);
